...
urlpatterns = [ 
  ...
  path('inbox/', views.inbox, name='users-inbox'),
  path('message/<str:pk>/', views.view_message, name='users-view-message'),
  path('create-message/<str:pk>/', views.create_message, name='users-create-message'),
]